                            ...
                            <div className="col-sm-12 col-md-12 col-lg-12 form-wizard ">
                                ...
                                <form action="#">
                                    <fieldset>
                                        ...
                                        <p className="instructions mx-3"><span className="text-decoration-underline heading">Instructions: </span> <br />
                                            This form will require about 30-40 minutes of your time to complete and will auto-save the details you have entered should you decide to continue at a later period. Do take note that the same device must be used to continue where you left off.
                                        </p>
